# Output contract — Agent 01 Jira Requirement Agent
...
```json
{
  "agent": "01_jira-requirement-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/01_jira-requirement-agent/...",
