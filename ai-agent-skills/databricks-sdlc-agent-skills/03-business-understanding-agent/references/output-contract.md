# Output contract — Agent 03 Business Understanding Agent
...
```json
{
  "agent": "03_business-understanding-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/03_business-understanding-agent/...",
