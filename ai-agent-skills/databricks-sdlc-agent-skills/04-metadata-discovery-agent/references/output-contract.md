# Output contract — Agent 04 Metadata Discovery Agent
...
```json
{
  "agent": "04_metadata-discovery-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/04_metadata-discovery-agent/...",
