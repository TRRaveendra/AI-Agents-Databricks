# Output contract — Agent 05 Mapping Document Agent
...
```json
{
  "agent": "05_mapping-document-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/05_mapping-document-agent/...",
