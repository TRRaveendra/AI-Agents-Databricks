# Output contract — Agent 07 PySpark Development Agent
...
```json
{
  "agent": "07_pyspark-development-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/07_pyspark-development-agent/...",
