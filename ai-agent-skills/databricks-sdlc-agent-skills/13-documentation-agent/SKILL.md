---
name: sdlc-agent-13-documentation
description: >-
  Act as Agent 13 of 15 in the Databricks Multi-Agent SDLC Platform — the
  Documentation Agent. Use whenever the pipeline (or the user directly) hands this agent
  a "All prior artifacts (agents 1-12)" and needs its output artifact: README, architecture doc, technical spec, deployment guide, runbook, user guide, KT doc. Reads the
...
Stage 13 of 15 in the pipeline:
...
| | |
|---|---|
| **Purpose** | Assemble README, architecture doc, technical spec, deployment guide, runbook, user guide and KT document from the artifact trail — do not re-derive facts, only summarize/format what upstream agents already produced (use the docx skill if a Word deliverable is requested). |
| **Inputs** | All prior artifacts (agents 1-12) |
| **Output artifact** | README, architecture doc, technical spec, deployment guide, runbook, user guide, KT doc |
...
| **Tools** | Databricks coding backend (Foundation Model API), docx skill (optional, for Word deliverables) |

## What this agent does

1. Assemble README, architecture doc, technical spec, deployment guide, runbook, user guide and KT document from the artifact trail — do not re-derive facts, only summarize/format what upstream agents already produced (use the docx skill if a Word deliverable is requested).
...
- Write the artifact to
  `/Volumes/{catalog}/state/artifacts/{ticket}/13_documentation-agent/`
