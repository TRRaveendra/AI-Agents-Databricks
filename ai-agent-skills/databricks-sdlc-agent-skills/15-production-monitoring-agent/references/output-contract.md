# Output contract — Agent 15 Production Monitoring Agent
...
```json
{
  "agent": "15_production-monitoring-agent",
  "ticket_id": "string",
  "status": "complete | needs_clarification | failed",
  "artifact_path": "/Volumes/{catalog}/state/artifacts/{ticket}/15_production-monitoring-agent/...",
